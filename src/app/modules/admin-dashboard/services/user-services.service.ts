...
export class UserServicesService {
  private mainUrl = Constants.host;

  private getAllUrl = `${this.mainUrl}user/getAll`;
  private roleChangeUrl = `${this.mainUrl}user/changeRole`;
  private deactivationUrl = `${this.mainUrl}user/deactivate`;
  private activationUrl = `${this.mainUrl}user/activate`;
